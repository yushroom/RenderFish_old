...
void Camera::Pitch(float angle)
{
	...
	Matrix4x4 R = Matrix4x4::RotationAxis(mRight, angle);
...
void Camera::UpdateViewMatrix()
{
	...
	mLook = mLook.Normalize();
	mUp = Vector3::Cross(mLook, mRight).Normalize();
	...
	float z = -Vector3::Dot(mPosition, mLook);
